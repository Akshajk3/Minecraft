    ...
    for (int x = -2; x <= 2; x++)
    {
        for (int z = -2; z <= 2; z++)
        {
            for (int face = 0; face < 6; face++)
            {
                ...
                {
                    treeVertices.insert(treeVertices.end(), {
                        position.x + x,     position.y + height,     position.z + z + 1,
                        position.x + x,     position.y + height + 1, position.z + z + 1,
                        position.x + x + 1, position.y + height + 1, position.z + z + 1,
                        position.x + x + 1, position.y + height,     position.z + z + 1,
                    });
                ...
                {
                    treeVertices.insert(treeVertices.end(), {
                        position.x + x,     position.y + height,     position.z + z,             // Vertex 0
                        position.x + x + 1, position.y + height,     position.z + z,         // Vertex 1
                        position.x + x + 1, position.y + height + 1, position.z + z,     // Vertex 2
                        position.x + x,     position.y + height + 1, position.z + z,         // Vertex 3
                    });
                ...
                {
                    treeVertices.insert(treeVertices.end(), {
                        position.x + x + 1, position.y + height,     position.z + z + 1, // Vertex 0
                        position.x + x + 1, position.y + height + 1, position.z + z + 1, // Vertex 1
                        position.x + x + 1, position.y + height + 1, position.z + z, // Vertex 2
                        position.x + x + 1, position.y + height,     position.z + z, // Vertex 3
                    });
                ...
                if (face == 3)
                {
                    treeVertices.insert(treeVertices.end(), {
                        ...
                        position.x + x, position.y + height + 1, position.z + z,
                        position.x + x, position.y + height + 1, position.z + z + 1,
                        position.x + x, position.y + height,     position.z + z + 1,
                    });
                ...
                if (face == 4)
                {
                    treeVertices.insert(treeVertices.end(), {
                        position.x + x,     position.y + height + 1, position.z + z,
                        position.x + x + 1, position.y + height + 1, position.z + z,
                        position.x + x + 1, position.y + height + 1, position.z + z + 1,
                        position.x + x,     position.y + height + 1, position.z + z + 1,
                    });
                ...
                if (face == 5)
                {
                    treeVertices.insert(treeVertices.end(), {
                        position.x + x,     position.y + height, position.z + z, // Vertex 0
                        position.x + x,     position.y + height, position.z + z + 1, // Vertex 1
                        position.x + x + 1, position.y + height, position.z + z + 1, // Vertex 2
                        position.x + x + 1, position.y + height, position.z + z, // Vertex 3
                    });
