...
void Tree::GenerateLeaves()
{
    ...
    for (int face = 0; face < 6; face++)
    {
        ...
        {
            treeVertices.insert(treeVertices.end(), {
                position.x, position.y + height, position.z + 1,
                position.x, position.y + height + 1, position.z + 1,
                position.x + 1, position.y + height + 1, position.z + 1,
                position.x + 1, position.y + height, position.z + 1,
            });
        ...
        {
            treeVertices.insert(treeVertices.end(), {
                position.x, position.y + height, position.z,             // Vertex 0
                position.x + 1, position.y + height, position.z,         // Vertex 1
                position.x + 1, position.y + height + 1, position.z,     // Vertex 2
                position.x, position.y + height + 1, position.z,         // Vertex 3
            });
        ...
        {
            treeVertices.insert(treeVertices.end(), {
                position.x + 1, position.y + height, position.z + 1, // Vertex 0
                position.x + 1, position.y + height + 1, position.z + 1, // Vertex 1
                position.x + 1, position.y + height + 1, position.z, // Vertex 2
                position.x + 1, position.y + height, position.z, // Vertex 3
            });
        ...
        if (face == 3)
        {
            treeVertices.insert(treeVertices.end(), {
                ...
                position.x, position.y + height + 1, position.z,
                position.x, position.y + height + 1, position.z + 1,
                position.x, position.y + height, position.z + 1,
            });
        ...
        if (face == 4)
        {
            treeVertices.insert(treeVertices.end(), {
                position.x, position.y + height + 1, position.z,
                position.x + 1, position.y + height + 1, position.z,
                position.x + 1, position.y + height + 1, position.z + 1,
                position.x, position.y + height + 1, position.z + 1,
            });
        ...
        if (face == 5)
        {
            treeVertices.insert(treeVertices.end(), {
                position.x, position.y + height, position.z, // Vertex 0
                position.x, position.y + height, position.z + 1, // Vertex 1
                position.x + 1, position.y + height, position.z + 1, // Vertex 2
                position.x + 1, position.y + height, position.z, // Vertex 3
            });
